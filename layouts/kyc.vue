<template>
  <div class="w-full h-screen flex flex-row">
    ...
    <div class="flex-1 overflow-auto h-full dark:bg-black dark:text-white">
      <div class="relative">
        <div
          class="p-[2.5rem] dark:bg-black bg-white sticky top-0 flex flex-row items-center pt-[2.1875rem]"
        >
