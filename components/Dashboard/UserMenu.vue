<template>
  <div
    class="inline-flex items-center gap-[0.5rem] px-[0.875rem] py-[0.3125rem] rounded-md hover:outline-slate-200 hover:outline outline-solid dark:hover:bg-slate-600 active:ring-4 active:ring-slate-200 flex-row"
  >
