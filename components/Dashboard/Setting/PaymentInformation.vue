        ...
        <div class="flex md:flex-row flex-col">
          ...
          <div class="flex items-center w-full">
            ...
            <div class="relative w-full">
              <div
                class="tima-select-default"
                @click="selectPaymentModal = !selectPaymentModal"
              >
                <div>
                ...
                <div class="ml-2">
                  <UtSvg name="chevron-down" dim w="12px" h="12px" />
                </div>
              </div>
        ...
        <div class="flex md:flex-row flex-col">
          ...
          <div class="flex items-center w-full">
            ...
            <div class="relative w-full">
              <div
                class="tima-select-default"
                @click="selectBankAccountModal = !selectBankAccountModal"
              >
                <div>
              ...
              <transition mode="out-in">
                <div
                  ...
                  v-if="selectBankAccountModal"
                  class="bg-white z-10 absolute top-[10px] right-0 max-w-[528px] w-full flex flex-col gap-2 rounded-lg border"
                >
                  <div class="px-6 py-6 relative">
                    <div
                      class="flex items-start justify-between border-b border-[#D9D9D9]"
                    >
                      <div class="pb-4">
                        <p class="text-[#333333] text-lg font-semibold">
                      ...
                      <button
                        ...
                        @click="selectBankAccountModal = false"
                      >
        ...
        <div class="flex md:flex-row flex-col">
          ...
          <div class="flex items-center w-full">
            ...
            <div class="relative w-full">
              <div
                class="tima-select-default"
                @click="resetPinModal = !resetPinModal"
              >
                <div>
              ...
              <transition mode="out-in">
                <div
                  ref="resetPinModalRef"
                  v-if="resetPinModal"
                  class="bg-white z-10 absolute top-[10px] right-0 max-w-[528px] w-full flex flex-col gap-2 rounded-2xl border"
                >
                  <div class="px-4 pt-2">
                    <div
                      class="py-2 mx-5 flex items-start justify-between border-b border-[#D9D9D9]"
                    >
                      <div>
                        <p class="text-[#333333] text-lg font-semibold">
      ...
      >
        <section class="bg-white p-8 rounded-2xl">
          ...
          <p class="mx-auto text-center text-[#545454] max-w-[25rem] text-sm">
            Check your email at yowa@gmail.com for the confirmation code. Enter
            it soon, before it expires. Welcome aboard!
          </p>
          ...
          <div class="px-4 py-6">
            ...
            >
              <div>
                ...
                <p class="text-[#545454] text-[10px] font-semibold">
                  Please input your bank account
                </p>
              </div>
    ...
    <div v-if="false">
      ...
      >
        ...
        >
          <div class="px-4 py-6">
            <div
              class="py-2 flex items-start justify-between border-b border-[#D9D9D9]"
            >
              <div>
                <p class="text-[#333333] text-lg font-semibold">
                  Create Transaction PIN
