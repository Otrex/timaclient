    ...
    <div>
      <div class="flex gap-3 text-lg text-[#545454] flex-row">
        <button class="px-6 py-1 rounded-[0.25rem] hover:bg-[#99D3FF]/70"
          :class="activeTab === 0 && 'bg-[#99D3FF]/30 text-[#058EF8]'" @click="activeTab = 0">
          Task
        </button>
        <button class="px-6 py-1 rounded-[0.25rem] hover:bg-[#99D3FF]/70"
          :class="activeTab === 1 && 'bg-[#99D3FF]/30 text-[#058EF8]'" @click="activeTab = 1">
          Set Reminder
        </button>
        <button class="px-6 py-1 rounded-[0.25rem] hover:bg-[#99D3FF]/70"
          :class="activeTab === 2 && 'bg-[#99D3FF]/30 text-[#058EF8]'" @click="activeTab = 2">
      ...
      <div>
        ...
        <template v-if="activeTab === 0">
          <div class="mt-4">
            ...
            <input class="border-b-2 w-full text-base py-2 focus:outline-none focus:border-blue-600"
          ...
          <div class="flex items-center gap-3 py-4">
            ...
            <div class="flex gap-3">
              <div class="bg-[#D9D9D9] text-[#545454] p-3 rounded-md">Aug 23, 2024</div>
              <div class="bg-[#D9D9D9] text-[#545454] p-3 rounded-md">1:30 PM</div>
            </div>
          </div>
        ...
        <template v-if="activeTab === 1">
          <div class="flex items-center gap-3 py-4">
            ...
            <div class="flex gap-3">
              <button class="text-base px-6 py-1 rounded-[0.25rem] hover:bg-[#99D3FF]/70"
                :class="reminderTab === 'EMAIL' && 'bg-[#99D3FF]/30 text-[#058EF8]'">
                Email
              </button>
              <button class="text-base px-6 py-1 rounded-[0.25rem] hover:bg-[#99D3FF]/70"
                :class="reminderTab === 'SMS' && 'bg-[#99D3FF]/30 text-[#058EF8]'">
                SMS
              </button>
              <button class="text-base px-6 py-1 rounded-[0.25rem] hover:bg-[#99D3FF]/70"
                :class="reminderTab === 'PUSH_NOTIFICATION' && 'bg-[#99D3FF]/30 text-[#058EF8]'">
                Push notification
              </button>
            </div>
          </div>
        ...
        <template v-if="activeTab === 2">
          ...
          <div class="flex items-center gap-3 py-4">
            ...
            <div v-for="(media, idx) in ['instagram', 'youtube', 'tiktok', 'facebook', 'x', 'linkedIn']" :key="idx"
              class="border inline-flex rounded-md mr-2 items-center justify-center max-w-[3.125rem] p-[0.625rem] border-[--input-border-color]">
              <UtSvg :name="tools.resolveSocialsIcon(media)" class="h-[1.3125rem] max-w-[1.9375rem]" />
            </div>
          </div>
          ...
          <div class="flex items-center justify-end gap-3 py-4">
            <UiButtonDefault variant="primary" label="Save"
