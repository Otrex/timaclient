    ...
    <div class="p-10">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex flex-row gap-5">
                <div class="bg-gray-100 rounded-md gap-4 py-1 items-center flex flex-row">
            ...
            <div class="max-h-screen overflow-y-auto">
                <table class="w-full">
                    ...
                    <tr v-for="(time, index) in timeSlots" :key="index">
                        <td class="align-top border-l border-r relative"
                        ...
                        <template v-for="(day, index) in daysOfWeek" :key="index">
                            <td class="w-[calc(100%/7)] border">
                                <div class="aspect-square w-full p-1">
                                    <CalendarEvent v-if="getEvent(day, time)" v-bind="getEvent(day, time)" />
                                    <div v-else>&nbsp;</div>
                                </div>
                            </td>
                        </template>
